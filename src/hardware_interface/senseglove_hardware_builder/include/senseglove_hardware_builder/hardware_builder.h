...
public:
     ...
     */
    HardwareBuilder(AllowedRobot robot, std::shared_ptr<urdf::Model> urdf);
     ...
     */
    HardwareBuilder(const std::string &yaml_path, std::shared_ptr<urdf::Model> urdf);
    ...
    static senseglove::SenseGloveRobot createRobot(const YAML::Node &joint_config, std::shared_ptr<urdf::Model> urdf,
...
private:
    ...
    std::vector<senseglove::SenseGloveRobot> createRobots(const YAML::Node &robots_config, std::shared_ptr<urdf::Model> urdf,
