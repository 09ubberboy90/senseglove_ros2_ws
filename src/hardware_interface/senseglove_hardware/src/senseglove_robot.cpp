...
namespace senseglove
{
    ...
    bool SenseGloveRobot::updateGloveData()
    {
        rclcpp::Clock clock;
        ...
        {
            RCLCPP_DEBUG_THROTTLE(rclcpp::get_logger("senseglove_robot"), clock, 2, "Unsuccessfully updated glove pose data");
        }
        else
        {
        ...
        {
            RCLCPP_DEBUG_THROTTLE(rclcpp::get_logger("senseglove_robot"), clock, 2, "Unsuccessfully updated hand pose data");
        }
        else
        {
            hand_update = true;
